...
Local files in this folder. Paths are `/images/<filename>` (served from `public/`).

| File | Used for |
| --- | --- |
| `img-1.png` | Cab studio (legacy) |
| `img-2.png` | Parcel — hero, gallery, experience, booking tab |
| `img-3.png` | Ambulance — hero, gallery, experience, SOS tab |
| `pic-4.png` | Bike promo (legacy) |
| `pic-5.png` | E-auto promo |
| `pic-6.png` | Travel & stay promo |
| `pic-7.png` | Best fares (Why WaveGo) |
| `pic-8.png` | Quick pickup / fares (Why WaveGo) |
